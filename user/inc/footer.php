            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-5">
                    ...
                    <form action="danhgia.php" method="POST">
                        ...
                        <div class="form-group">
                            <textarea class="form-control border-0 py-4" name="feedback" placeholder="Góp ý của bạn" required></textarea>
                        </div>
    ...
    <div class="row border-top border-light mx-xl-5 py-4">
        <div class="col-md-6 px-xl-0">
            <p class="mb-md-0 text-center text-md-left text-dark">
                ...
                <a class="text-dark font-weight-semi-bold" href="https://www.facebook.com/Jun.sb999" target="_blank">Group 3</a>
            </p>
        </div>
