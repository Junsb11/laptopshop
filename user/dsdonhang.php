...
<style>
    ...
    padding: 5px 10px; /* Giảm kích thước padding để làm nhỏ nút */
    font-size: 12px; /* Đặt kích thước chữ nhỏ hơn */
    font-weight: bold; /* Làm đậm chữ */
    transition: all 0.3s ease; /* Thêm hiệu ứng chuyển tiếp khi hover */
}

.btn-xacnhan:hover {
    background-color: #218838; /* Màu nền khi hover */
    transform: scale(1.05); /* Tăng kích thước khi hover */
    box-shadow: 0px 4px 10px rgba(0, 0, 0, 0.1); /* Thêm bóng đổ khi hover */
}

.btn-xacnhan:active {
    background-color: #1e7e34; /* Màu nền khi click */
    transform: scale(1); /* Trở về kích thước bình thường khi click */
}
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php if ($data['TrangThai'] == 1) { ?>
                                                <a href="xacnhandonhang.php?mahd=<?php echo $data['MaHD']; ?>" class="btn btn-xacnhan btn-sm">
